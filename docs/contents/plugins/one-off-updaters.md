...
Install [pixi-skills](https://pixi.prefix.dev/latest/integration/extensions/pixi_skills/) once and configure the skill for your coding agent:
...
You can also install the skill directly from the repository with the [`skills` CLI](https://github.com/vercel-labs/skills):
