...
const ComboboxInputGroup = ({ className, ...props }: ComboboxPrimitive.InputGroup.Props) => (
  <ComboboxPrimitive.InputGroup
    className={cn(
      'flex min-h-10 rounded-md border border-solid border-border bg-white focus-within:outline-2 focus-within:outline-offset-1 focus-within:outline-ring',
      className
    )}
...
const ComboboxItem = ({
  ...
  <ComboboxPrimitive.Item
    className={cn(
      'flex w-full cursor-pointer items-center gap-2 rounded-sm py-1.5 text-left text-xs outline-none select-none hover:bg-muted data-disabled:pointer-events-none data-disabled:opacity-45 data-highlighted:bg-primary-subtle',
