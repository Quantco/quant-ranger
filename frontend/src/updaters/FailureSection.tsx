...
const createFailureColumns = (onSelect: (failure: FailureItem) => void): DataTableColumn<FailureItem>[] => [
  {
...
const FailureDialog = ({ failure, onClose }: { failure: FailureItem | null; onClose: () => void }) => (
  <Dialog
    onOpenChange={(open) => {
      if (!open) onClose()
    }}
